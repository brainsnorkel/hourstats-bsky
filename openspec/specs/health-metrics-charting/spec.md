# health-metrics-charting Specification

## Purpose
Provides HTTP API endpoints and chart rendering for visualizing health metrics collected by the stats collector. Includes a multi-panel PNG chart generator, JSON history endpoint, and a CLI plot command for terminal-based monitoring.
