# health-metrics-collection Specification

## Purpose
Extends the stats collector to sample runtime health metrics (memory, GC, I/O pressure, WAL size, goroutines, cycle timing) at each snapshot interval and persist them to the stats_snapshots table for operational monitoring.
