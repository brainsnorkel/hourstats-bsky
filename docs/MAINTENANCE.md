...
| Wikipedia | `https://en.wikipedia.org/wiki/Portal:Current_events/YYYY_Month_D` | Link targets only. If the portal's subpage naming changes, the yearly-chart facets and trending footer links break silently. | `internal/wikipedia` |
